...
public class GameRules {
    ...
    public static final double CONTENT_DURATION_CHANGE_INTERVAL = 30.0;
    ...
    public static final int HAMSTER_CONTENT_MISSED_POINTS = -50;
    public static final int BUNNY_CONTENT_TAPPED_POINTS = -100;
